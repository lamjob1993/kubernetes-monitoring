...
Про опыт с Java и Kubernetes, советую заучить и приступать уже сегодня (Антон спросил, а не рано нам писать в стеке: Java? - нет, Антон, не рано:)), по сути это ваш стек Java+K8S для ответов на собеседовании: 
